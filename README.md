...
<img src="https://capsule-render.vercel.app/api?type=waving&color=7c5cbf&height=140&section=header&text=Thiago%20Emanuel&fontSize=42&fontColor=ffffff&fontAlignY=55&animation=fadeIn" width="100%"/>
...
const thiago = {
  ...
  estudando:  ["React.js", "AWS", "Flutter"],
  pronomes:   "ele/dele",
};
```
...
|---|---|---|
| [🍵 Chá e Encantos](https://site-cha-e-encantos.vercel.app/telaMenu/Menu.html) | E-commerce de chás com catálogo, carrinho e área admin | Firebase · HTML · CSS · JS |
